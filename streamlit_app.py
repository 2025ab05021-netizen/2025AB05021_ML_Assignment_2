...
def load_data():
    ...
    try:
        ...
        try:
            ...
            return results_df, df.head(1000)  # Sample for demo
        except:
            ...
            dummy_data = pd.DataFrame({
                ...
                'glucose_level': np.random.randint(80, 200, 100),
                'diabetes': np.random.choice([0, 1], 100)
            })
            return results_df, dummy_data
...
def load_models():
    ...
    try:
        ...
        try:
            ...
            scaler = None
            metadata = {'feature_names': ['feature1', 'feature2'], 'target_classes': ['No Diabetes', 'Diabetes']}
