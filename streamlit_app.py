...
def main():
    ...
    st.markdown("""This project evaluates multiple classification models trained for the assignment.\
The app provides the essential functionality required by the assignment:""")
    ...
    # 1) Dataset upload
    uploaded = st.file_uploader("Upload test CSV (optional). If none, the default dataset will be used.", type=['csv'])
